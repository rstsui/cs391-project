        ...
        <div className="flex flex-col md:flex-row gap-10 w-full max-w-6xl">
          ...
          <div className="md:w-2/3 w-full bg-white p-8 rounded-2xl shadow-sm">
            ...
            <p className="text-gray-700 mb-8 leading-relaxed">
              Enjoy freshly baked cookies and help us reduce food waste! Bring your
              friends and enjoy leftover snacks from BU Spark! events. Cookies will
              be available on a first-come, first-serve basis, so make sure to
              reserve early!
            </p>

            <div className="space-y-3 mb-8 text-gray-600 text-sm">
              <p>
                <strong>Location:</strong> BU Spark! — 665 Commonwealth Ave, Floor 2
              </p>
              <p>
                <strong>Time:</strong> Friday, Nov 3, 3:00 PM – 5:00 PM
              </p>
              <p>
                <strong>Hosted by:</strong> BU Spark! Sustainability Team
              </p>
            </div>
            ...
            <div className="bg-teal-600 text-white p-8 rounded-2xl shadow-md h-full flex flex-col justify-center">
              ...
              <form className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <select className="p-2 w-full rounded-md text-black focus:outline-none focus:ring-2 focus:ring-teal-300">
