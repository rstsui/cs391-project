...
function SignupPage() {
    ...
    if ($[0] !== "0ec550e5928dd9950555fd164652edfb98a2ddb9c506fa08be405c58d2396733") {
        for(let $i = 0; $i < 18; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0ec550e5928dd9950555fd164652edfb98a2ddb9c506fa08be405c58d2396733";
    }
    ...
    if ($[1] !== confirm || $[2] !== email || $[3] !== password || $[4] !== router) {
        t0 = ({
            "SignupPage[handleSignup]": async ()=>{
                ...
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                    email,
                    password
                });
                if (error) {
