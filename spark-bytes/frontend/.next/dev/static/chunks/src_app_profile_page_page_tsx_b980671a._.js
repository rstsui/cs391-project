...
"[project]/src/app/profile_page/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfilePage() {
        ...
        t0 = ({
            "ProfilePage[useEffect()]": ()=>{
                const loadProfile = async function loadProfile() {
                    ...
                    const { data: profileData } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("email, role").eq("id", authData.user.id).single();
    ...
    if ($[3] !== profile.email) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
            ...
            fileName: "[project]/src/app/profile_page/page.tsx",
            lineNumber: 50,
            columnNumber: 10
        }, this);
        $[3] = profile.email;
    ...
    let t9;
    if ($[13] !== profile.role) {
        t9 = profile.role === "admin" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: "/admin/requests",
    ...
    let t10;
    if ($[15] !== profile.role) {
        t10 = profile.role !== "admin" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
            href: "/request_access",
...
//# sourceMappingURL=src_app_profile_page_page_tsx_b980671a._.js.map