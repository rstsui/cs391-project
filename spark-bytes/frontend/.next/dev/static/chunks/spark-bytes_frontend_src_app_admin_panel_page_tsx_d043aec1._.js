...
"[project]/spark-bytes/frontend/src/app/admin_panel/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminPanel() {
    ...
    if ($[0] !== "e2547d61d15a9db65ef40e510f1ee0ab4c5efe2b9e39f02cb0fef31125abf6a2") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e2547d61d15a9db65ef40e510f1ee0ab4c5efe2b9e39f02cb0fef31125abf6a2";
    }
        ...
        t1 = ({
            "AdminPanel[useEffect()]": ()=>{
                const checkRole = async function checkRole() {
                    const { data: t2 } = await __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    const { user } = t2;
                    if (!user) {
                        router.push("/login");
                        return;
    ...
    if ($[5] !== authorized) {
        t3 = ({
            "AdminPanel[useEffect()]": ()=>{
                ...
                const loadRequests = async function loadRequests() {
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("admin_requests").select("*").order("created_at", {
                        ascending: false
                    });
                    if (!error) {
                        setRequests(data || []);
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = async function approveRequest(request) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").update({
                role: "admin"
            }).eq("id", request.user_id);
            await __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("admin_requests").delete().eq("id", request.id);
            setRequests({
                "AdminPanel[approveRequest > setRequests()]": (prev)=>prev.filter({
                        "AdminPanel[approveRequest > setRequests() > prev.filter()]": (r)=>r.id !== request.id
                    }["AdminPanel[approveRequest > setRequests() > prev.filter()]"])
            }["AdminPanel[approveRequest > setRequests()]"]);
        };
        $[8] = t5;
    } else {
        t5 = $[8];
    }
    const approveRequest = t5;
    if (!authorized) {
        return null;
    }
    let t6;
    ...
    if ($[10] !== loading || $[11] !== requests) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                t6,
                loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    lineNumber: 128,
                    columnNumber: 132
                }, this) : requests.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-center text-gray-600",
                    ...
                    children: requests.map({
                        "AdminPanel[requests.map()]": (req)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$spark$2d$bytes$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "AdminPanel[requests.map() > <button>.onClick]": ()=>approveRequest(req)
                                        }["AdminPanel[requests.map() > <button>.onClick]"],
...
_s(AdminPanel, "2TSOknL/6pn1IQcPr76v82mb0B0=", false, function() {
    return [
...
//# sourceMappingURL=spark-bytes_frontend_src_app_admin_panel_page_tsx_d043aec1._.js.map