...
function AdminEventsPage() {
    ...
    if ($[0] !== "3c5dd3557c587cfcc361583a9149e9e2ec9ed5ecefdca9a6b5ab1e781312be64") {
        for(let $i = 0; $i < 49; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3c5dd3557c587cfcc361583a9149e9e2ec9ed5ecefdca9a6b5ab1e781312be64";
    }
    ...
    const [rsvps, setRsvps] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    let t2;
    ...
    const [showRsvpsMap, setShowRsvpsMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t2);
    ...
    const [editFoodItems, setEditFoodItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t3);
    let t4;
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "AdminEventsPage[loadAdminEvents]": async (userId)=>{
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("events").select("*").eq("host_id", userId).order("created_at", {
                    ascending: false
                });
                if (error) {
                    console.error(error);
                ...
                if (eventIds.length > 0) {
                    const { data: rsvpData, error: rsvpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("rsvps").select("*").in("event_id", eventIds);
                    if (rsvpError) {
        ...
        t5 = ({
            "AdminEventsPage[useEffect()]": ()=>{
                const checkRole = async function checkRole() {
                    const { data: t7 } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    const { user } = t7;
                    if (!user) {
                        router.push("/login");
                        return;
                    }
                    const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("role").eq("id", user.id).single();
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = ({
            "AdminEventsPage[handleDelete]": async (eventId)=>{
                ...
                const { error: error_0 } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("events").delete().eq("id", eventId);
                if (error_0) {
                    ...
                    setRsvps({
                        "AdminEventsPage[handleDelete > setRsvps()]": (prev_0)=>prev_0.filter({
                                "AdminEventsPage[handleDelete > setRsvps() > prev_0.filter()]": (r)=>r.event_id !== eventId
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = ({
            "AdminEventsPage[handleCancel]": async (eventId_0)=>{
                ...
                const { error: error_1 } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("events").update({
                    status: "cancelled"
                }).eq("id", eventId_0);
                if (error_1) {
    ...
    if ($[16] !== editDate || $[17] !== editFoodItems || $[18] !== editLocation || $[19] !== editTime || $[20] !== editTitle || $[21] !== editingEvent) {
        t14 = ({
            "AdminEventsPage[handleEditSubmit]": async ()=>{
                ...
                const { error: error_2 } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("events").update({
                    title: editTitle,
    ...
    let t17;
    if ($[25] !== events.length) {
        t17 = events.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    if ($[27] !== events || $[28] !== rsvps || $[29] !== showRsvpsMap) {
        ...
        if ($[31] !== rsvps || $[32] !== showRsvpsMap) {
            t19 = ({
                "AdminEventsPage[events.map()]": (event_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: [
                                    event_0.title,
                                    " ",
                                    event_0.status === "cancelled" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            showRsvpsMap[event_0.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    rsvps.filter({
                                        "AdminEventsPage[events.map() > rsvps.filter()]": (r_2)=>r_2.event_id === event_0.id
                                    }["AdminEventsPage[events.map() > rsvps.filter()]"]).length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: rsvps.filter({
                                            "AdminEventsPage[events.map() > rsvps.filter()]": (r_0)=>r_0.event_id === event_0.id
    ...
    if ($[37] !== editDate || $[38] !== editFoodItems || $[39] !== editLocation || $[40] !== editTime || $[41] !== editTitle || $[42] !== editingEvent || $[43] !== handleEditSubmit) {
        t20 = editingEvent && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            editFoodItems.map({
                                "AdminEventsPage[editFoodItems.map()]": (item_0, index_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c = AdminEventsPage;
function _AdminEventsPageEventsMapAnonymous2(r_1) {
